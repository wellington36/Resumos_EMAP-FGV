...
\newcommand{\duedate}{April 17, 2022}
...
\section*{Teorema da integral de Cauchy para domínios multi-conexos}
\label{s6}
...
Se $f$ for analítica em $D^\star$ multi-conexo com $C_1, \ldots, C_n$ ``borda interior'' e C ``borda exterior'', onde todas são orientedas no sentido anti-horário. Então
